---
id: version-2.1.24-test-open-census-configuration
...
1. Make sure you are using the same version of OpenCensus as inspectIT Ocelot.
   ...
   The inspectIT Ocelot agent in version 2.1.24-test internally uses OpenCensus in version 0.28.3. Please adapt any OpenCensus dependency in your application to this version to avoid run-time conflicts.
   ```XML
   <dependency>
