---
id: version-2.0.20-test-configuration-sources
...
```bash
$ java -javaagent:/path/to/inspectit-ocelot-agent-2.0.20-test.jar="{ \"inspectit\": { \"service-name\": \"My Custom Service\" }}" -jar my-java-program.jar
```
...
```bash
$ java -Dinspectit.service-name="My Custom Service" -javaagent:/path/to/inspectit-ocelot-agent-2.0.20-test.jar -jar my-java-program.jar
```
...
```bash
$ INSPECTIT_SERVICE_NAME="My Custom Service" java -javaagent:/path/to/inspectit-ocelot-agent-2.0.20-test.jar -jar my-java-program.jar
```
